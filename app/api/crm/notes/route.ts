...
/**
 * GET  /api/crm/notes?reference_doctype=CRM Lead&reference_name=CRM-LEAD-0001
 * POST /api/crm/notes  body: { reference_doctype, reference_name, title, content }
 */
...
export async function POST(req: Request) {
  try {
    ...
    const { reference_doctype, reference_name, title, content } = body;
