...
// Quotations endpoint. Lists sales quotations with optional status filter and company
// scope. Pagination is supported via limit and offset.
export async function GET(req: Request) {
  try {
    ...
    const result = await erpMethod("fuze_suite.api.sales.get_quotations", args);
