...
const outcomes = [
  ...
  "Run on Business Suite without exposing confusing backend screens",
  ...
  return (
    <div className="public-root premium-website">
      ...
      <section className="site-section story-split">
        ...
        <div className="product-visual-card"><b>Business Suite backbone</b><span>Hidden behind a modern SaaS portal.</span><i>CRM → Quote → Invoice → Payment → Support</i></div>
      </section>
