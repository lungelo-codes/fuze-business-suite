            ...
            <>
              ...
              <div className="field">
                ...
                <div className="site-name-wrap">
                  ...
                  <span className="site-suffix">.fuze.co.za</span>
                </div>
                <div className="field-hint">This will be the URL of your ERPNext instance</div>
              </div>
            </>
          )}
          ...
          {step < 5 && (
            <div className="signup-nav">
              ...
              {step < 4
                ...
                : <button className="btn btn-primary" onClick={submit} disabled={loading}>{loading ? "Creating account…" : "Create Account →"}</button>
              }
            </div>
          )}
        </div>
