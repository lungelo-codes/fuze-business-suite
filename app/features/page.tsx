...
export default function FeaturesPage() {
  return (
    <div className="public-root premium-website">
      <PublicHeader />
      <section className="site-hero"><span className="suite-kicker">Features</span><h1>Every module has a clear job in the business.</h1><p>Business Suite is not a random menu of backend screens. Each module is presented as a workflow your client can understand from the website.</p></section>
