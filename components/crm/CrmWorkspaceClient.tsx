...
type Tab = "Command Center" | "Leads" | "Opportunities" | "Customers" | "Quotes" | "Sales Orders" | "Contracts" | "Activities" | "Automation" | "Production Readiness";
...
const TABS: Tab[] = ["Command Center", "Leads", "Opportunities", "Customers", "Quotes", "Sales Orders", "Contracts", "Activities", "Automation", "Production Readiness"];
...
function normalizeTab(value?: string): Tab {
  ...
  if (v.includes("contact")) return "Customers";
...
function CommandCenter({ cards, leads, deals, currency, setTab, onOpen }: { cards: Cards | null; leads: Lead[]; deals: Deal[]; currency: string; setTab: (tab: Tab) => void; onOpen: (r: DrawerRecord) => void }) {
  ...
  const stats = [
    ...
    { label: "Contacts", value: cards?.contacts ?? 0, hint: "People linked to customers", tab: "Customers" as Tab },
