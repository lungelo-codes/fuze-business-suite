...
const GROUPS: NavGroup[] = [
  ...
  { title: "Finance", items: [
    ...
    { label: "Accounting", href: "/portal/accounting", icon: "bank", module: "accounting" },
  ...
  { title: "People", items: [
    { label: "HR Workspace", href: "/portal/hr", icon: "person", module: "employees" },
    { label: "Employees", href: "/portal/employees", icon: "person", module: "employees" },
    { label: "Recruitment", href: "/portal/recruitment", icon: "target", module: "employees" },
    { label: "Job Openings", href: "/portal/job-openings", icon: "target", module: "employees" },
    { label: "Job Applicants", href: "/portal/job-applicants", icon: "users", module: "employees" },
    { label: "Onboarding", href: "/portal/hr-onboarding", icon: "task", module: "attendance" },
    { label: "Transfers", href: "/portal/hr-transfers", icon: "default", module: "employees" },
    { label: "Attendance", href: "/portal/attendance", icon: "task", module: "attendance" },
    { label: "Shift Assignments", href: "/portal/hr-shifts", icon: "calendar", module: "attendance" },
    { label: "Leave", href: "/portal/leave", icon: "calendar", module: "leave" },
    { label: "Expense Claims", href: "/portal/expense-claims", icon: "card", module: "employees" },
    { label: "Employee Loans", href: "/portal/hr-loans", icon: "card", module: "employees" },
    { label: "Appraisals", href: "/portal/appraisals", icon: "chart", module: "employees" },
    { label: "Exit Interviews", href: "/portal/exit-interviews", icon: "default", module: "employees" },
    { label: "Payroll", href: "/portal/payroll", icon: "card", module: "payroll" },
    { label: "Salary Structure", href: "/portal/salary-structure", icon: "invoice", module: "payroll" },
  ]},
  { title: "Service", items: [
    { label: "Support", href: "/portal/support", icon: "support", module: "support" },
    { label: "Helpdesk", href: "/portal/helpdesk", icon: "support", module: "helpdesk" },
