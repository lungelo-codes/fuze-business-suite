...
export default function Sidebar({ activeModules, companyName, companyLogo, role, onCollapse }: SidebarProps) {
  ...
  return (
    <aside className="sidebar">
      ...
      <div style={{ marginTop: "auto", padding: "12px 10px", borderTop: "1px solid var(--line)" }}><a className="nav-item" href="/api/auth/logout"><Icon name="default" />Sign Out</a></div>
    </aside>
  );
}
