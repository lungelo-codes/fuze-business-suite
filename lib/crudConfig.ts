...
export const CRUD_MODULES: Record<string, CrudModuleConfig> = {
  customers: {
    ...
    listFields: ["name", "customer_name", "customer_type", "customer_group", "territory", "email_id", "mobile_no", "tax_id", "customer_primary_contact", "customer_primary_address", "payment_terms", "default_price_list", "modified"],
    tableFields: [f("customer_name", "Customer"), f("customer_type", "Type"), f("customer_group", "Group"), f("territory", "Territory"), f("email_id", "Email", "email"), f("mobile_no", "Mobile", "tel"), f("tax_id", "Tax/VAT No"), f("payment_terms", "Payment Terms")],
    formFields: [f("customer_name", "Customer Name", "text", true), s("customer_type", "Customer Type", ["Company", "Individual"], true), l("customer_group", "Customer Group", "Customer Group", true, "All Customer Groups"), l("territory", "Territory", "Territory", true, "All Territories"), f("email_id", "Email", "email"), f("mobile_no", "Mobile", "tel"), f("tax_id", "Tax/VAT Number"), l("default_currency", "Default Currency", "Currency", false, "ZAR"), l("default_price_list", "Default Price List", "Price List", false, "Standard Selling"), l("payment_terms", "Payment Terms", "Payment Terms Template"), txt("customer_details", "Customer Details")],
  ...
  leads: {
    ...
    listFields: ["name", "lead_name", "company_name", "status", "source", "email_id", "mobile_no", "territory", "lead_owner", "request_type", "market_segment", "modified"],
    tableFields: [f("lead_name", "Lead"), f("company_name", "Company"), f("status", "Status"), f("source", "Source"), f("email_id", "Email", "email"), f("mobile_no", "Mobile", "tel"), f("territory", "Territory"), f("lead_owner", "Owner")],
    formFields: [f("lead_name", "Lead Name", "text", true), f("company_name", "Company"), s("status", "Status", ["Lead", "Open", "Replied", "Opportunity", "Quotation", "Lost Quotation", "Interested", "Converted", "Do Not Contact"]), s("source", "Source", ["Website", "Referral", "Advertisement", "Cold Calling", "Email", "Campaign", "Other"]), f("email_id", "Email", "email"), f("mobile_no", "Mobile", "tel"), f("phone", "Phone", "tel"), l("territory", "Territory", "Territory", false, "All Territories"), l("lead_owner", "Lead Owner", "User"), f("request_type", "Request Type"), l("market_segment", "Market Segment", "Market Segment"), f("website", "Website"), f("city", "City"), f("country", "Country", "text", false, undefined, "South Africa"), txt("notes", "Notes")],
  ...
  opportunities: {
    ...
    listFields: ["name", "opportunity_from", "party_name", "opportunity_type", "status", "sales_stage", "opportunity_amount", "currency", "expected_closing", "probability", "contact_person", "modified"],
    tableFields: [f("party_name", "Party"), f("opportunity_from", "From"), f("opportunity_type", "Type"), f("status", "Status"), f("sales_stage", "Stage"), n("opportunity_amount", "Amount"), f("currency", "Currency"), d("expected_closing", "Expected Close"), n("probability", "Probability %")],
    formFields: [s("opportunity_from", "Opportunity From", ["Lead", "Customer", "Prospect"], true), f("party_name", "Party Name", "text", true), l("opportunity_type", "Opportunity Type", "Opportunity Type", false, "Sales"), s("status", "Status", ["Open", "Quotation", "Converted", "Lost", "Closed"]), l("sales_stage", "Sales Stage", "Sales Stage", false, "Qualification"), n("opportunity_amount", "Opportunity Amount"), l("currency", "Currency", "Currency", false, "ZAR"), d("expected_closing", "Expected Closing"), n("probability", "Probability %"), l("contact_person", "Contact Person", "Contact"), f("customer_name", "Customer Name"), txt("description", "Description")],
    defaults: { opportunity_from: "Lead", status: "Open", sales_stage: "Qualification", probability: 10, currency: "ZAR", opportunity_type: "Sales" },
  },
  ...
  employees: {
    ...
    listFields: ["name", "employee_name", "first_name", "last_name", "gender", "department", "designation", "branch", "grade", "employment_type", "status", "date_of_joining", "cell_number", "company_email", "reports_to", "modified"],
    tableFields: [f("employee_name", "Employee"), l("department", "Department", "Department"), l("designation", "Designation", "Designation"), l("branch", "Branch", "Branch"), f("employment_type", "Employment Type"), f("status", "Status"), f("company_email", "Email", "email"), f("cell_number", "Cell", "tel"), d("date_of_joining", "Joined")],
    formFields: [f("first_name", "First Name", "text", true), f("middle_name", "Middle Name"), f("last_name", "Last Name"), l("gender", "Gender", "Gender"), d("date_of_birth", "Date of Birth"), d("date_of_joining", "Date of Joining", true), l("company", "Company", "Company"), l("department", "Department", "Department"), l("designation", "Designation", "Designation"), l("branch", "Branch", "Branch"), l("grade", "Employee Grade", "Employee Grade"), l("employment_type", "Employment Type", "Employment Type"), s("status", "Status", ["Active", "Inactive", "Suspended", "Left"]), f("company_email", "Company Email", "email"), f("personal_email", "Personal Email", "email"), f("cell_number", "Cell Number", "tel"), l("user_id", "Linked User", "User"), l("reports_to", "Reports To", "Employee")],
