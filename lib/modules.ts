...
export const ALL_MODULES: ModuleDef[] = [
  ...
  { id: "invoices", label: "Invoices", icon: "📄", description: "ERPNext sales invoices and payment status", path: "/portal/finance?tab=invoices", group: "Finance", addonPrice: 149, doctype: "Sales Invoice", active: true, includedIn: ["Starter", "Growth", "Business Pro"] },
  ...
  { id: "payments", label: "Payments", icon: "💳", description: "Payment Entry, payment links and reconciliation", path: "/portal/finance?tab=payments", group: "Finance", addonPrice: 99, doctype: "Payment Entry", active: true, includedIn: ["Starter", "Growth", "Business Pro"] },
  { id: "accounting", label: "Accounting", icon: "📚", description: "ERPNext accounting, receivables, payables and ledger reporting", path: "/portal/finance", group: "Finance", addonPrice: 249, doctype: "GL Entry", active: true, includedIn: ["Growth", "Business Pro"] },
  { id: "banking", label: "Banking", icon: "🏦", description: "Bank accounts, transactions and reconciliation", path: "/portal/finance?tab=banking", group: "Finance", addonPrice: 129, doctype: "Bank Transaction", active: true, includedIn: ["Growth", "Business Pro"] },
  { id: "compliance", label: "Compliance", icon: "⚖️", description: "VAT, PAYE, UIF, SDL and CIPC tracking", path: "/portal/finance?tab=compliance", group: "Finance", addonPrice: 129, doctype: "ToDo", active: true, includedIn: ["Starter", "Growth", "Business Pro"] },
  ...
  { id: "selling", label: "Selling", icon: "🧾", description: "ERPNext selling flow: quotation to order to invoice", path: "/portal/crm?tab=sales-orders", group: "CRM", addonPrice: 149, doctype: "Sales Order", active: true, includedIn: ["Growth", "Business Pro"] },
  { id: "sales-orders", label: "Sales Orders", icon: "🧾", description: "Confirmed customer orders", path: "/portal/crm?tab=sales-orders", group: "CRM", addonPrice: 149, doctype: "Sales Order", active: true, includedIn: ["Business Pro"] },
  ...
  { id: "buying", label: "Buying", icon: "🛒", description: "ERPNext buying flow: MR, RFQ, SQ, PO, receipt and invoice", path: "/portal/operations?tab=procurement", group: "Operations", addonPrice: 249, doctype: "Purchase Order", active: true, includedIn: ["Growth", "Business Pro"] },
  { id: "suppliers", label: "Suppliers", icon: "🚚", description: "Supplier master data and 360 view", path: "/portal/operations?tab=procurement", group: "Operations", addonPrice: 99, doctype: "Supplier", active: true, includedIn: ["Growth", "Business Pro"] },
  { id: "purchase-orders", label: "Purchase Orders", icon: "🛒", description: "Create and track purchase orders", path: "/portal/operations?tab=procurement", group: "Operations", addonPrice: 149, doctype: "Purchase Order", active: true, includedIn: ["Growth", "Business Pro"] },
  { id: "inventory", label: "Inventory", icon: "📦", description: "ERPNext stock balances, warehouses, ledger and entries", path: "/portal/operations?tab=inventory", group: "Operations", addonPrice: 149, doctype: "Item", active: true, includedIn: ["Growth", "Business Pro"] },
  { id: "items", label: "Items", icon: "📦", description: "Products, services and item pricing", path: "/portal/operations?tab=inventory", group: "Operations", addonPrice: 149, doctype: "Item", active: true, includedIn: ["Growth", "Business Pro"] },
  ...
  { id: "projects", label: "Projects", icon: "📊", description: "ERPNext projects, tasks, timesheets and profitability", path: "/portal/operations?tab=projects", group: "Operations", addonPrice: 149, doctype: "Project", active: true, includedIn: ["Growth", "Business Pro"] },
  { id: "tasks", label: "Tasks", icon: "✅", description: "Task assignments and deadlines", path: "/portal/operations?tab=projects", group: "Operations", addonPrice: 79, doctype: "Task", active: true, includedIn: ["Growth", "Business Pro"] },
  ...
  { id: "insights", label: "Insights", icon: "📈", description: "Frappe Insights-style analytics and reports", path: "/portal/reports", group: "Intelligence", addonPrice: 149, doctype: "Dashboard", active: true, includedIn: ["Growth", "Business Pro"] },
  { id: "ai", label: "z.ai Assistant", icon: "✨", description: "AI reporting, module summaries and improvement actions", path: "/portal/reports", group: "Intelligence", addonPrice: 199, doctype: "Fuze AI Insight", active: true, includedIn: ["Growth", "Business Pro"] },
];
