...
export const ALL_MODULES: ModuleDef[] = [
  ...
  { id: "leads", label: "Leads", icon: "🧲", description: "Capture and qualify new leads", path: "/portal/crm?tab=leads", group: "CRM", addonPrice: 99, doctype: "Lead", active: true, includedIn: ["Growth", "Business Pro"] },
  { id: "opportunities", label: "Opportunities", icon: "🎯", description: "Manage deals and sales opportunities", path: "/portal/crm?tab=opportunities", group: "CRM", addonPrice: 99, doctype: "Opportunity", active: true, includedIn: ["Growth", "Business Pro"] },
  ...
  { id: "documents", label: "Documents", icon: "📁", description: "Google Drive, Dropbox and workspace files", path: "/portal/documents", group: "Operations", addonPrice: 129, doctype: "File", active: true, includedIn: ["Business Pro"] },
